...
ddns.prototype.createDomainRecord = () => {
  return this.recordExists(this.ip, this.type, this.name)
    .then((exists) => {
      if (exists) {
        return {
          exists: 1
        ...
        return request.createDomainRecord(this.type, this.record, this.ip)
          .then((createdResult) => {
            return Object.extend(createdResult, {exists: 0});
          }).catch((e) => {
            console.log(e);
          });
      }
